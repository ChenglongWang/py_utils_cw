...
from .utilities import load_pickle, write_pickle, load_json, save_json
...
class DatasetAnalyzer(object):
    def __init__(self, folder_with_cropped_data, overwrite=True, num_processes=8):
        ...
        self.patient_identifiers = get_patient_id(self.folder_with_cropped_data)
    ...
    def analyse_segmentations(self):
        ...
        if self.overwrite or not isfile(self.props_per_case_file):
            ...
            write_pickle(props_per_patient, self.props_per_case_file)
        else:
...
if __name__ == "__main__":
    ...
    data_dir = r'\\mega\MRIData\kits19\data'
    dataset_analyzer = DatasetAnalyzer(data_dir, overwrite=False)
